...
- When:  2026-05-28T17:52:10.935Z

## ðŸ”´ Must fix

- **8 heading(s) on live but missing on local:**
  - h2#- Preserving Linda’s 1950s Martin 0-18 Legacy
...
- **3 broken asset URL(s) on local (returned non-200):**
  - 404 via HEAD â†’ http://localhost:4321/images/sell-martin/Model-Name-Serial-Number-Martin-1024x683.jpg
  - 404 via HEAD â†’ http://localhost:4321/images/sell-martin/1929-martin-00-21-1-1024x683.jpg
  - 404 via HEAD â†’ http://localhost:4321/images/sell-martin/1945-martin-d-18-1-1024x683.jpg
...
- **2 heading(s) on local but not on live (extra):**
  - h3#- Preserving Linda’s 1950s Martin 0-18 Legacy
...
- Asset URLs on local checked: 21, broken: 3

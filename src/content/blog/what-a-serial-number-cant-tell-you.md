...
draft: false
toc:
  - { href: "#what-a-serial-number-actually-proves", label: "What A Serial Number Actually Proves" }
  - { href: "#what-all-original-actually-means", label: "What All Original Actually Means" }
  - { href: "#the-bench-sequence", label: "The Bench Sequence" }
  - { href: "#finish-and-wear", label: "Finish And Wear", sub: true }
  - { href: "#hardware-footprints-and-extra-holes", label: "Hardware Footprints And Extra Holes", sub: true }
  - { href: "#cavities-routes-and-pot-codes", label: "Cavities, Routes, And Pot Codes", sub: true }
  - { href: "#solder-that-has-not-been-moved", label: "Solder That Has Not Been Moved", sub: true }
  - { href: "#pickups-and-whether-they-belong", label: "Pickups And Whether They Belong", sub: true }
  - { href: "#cross-dating-every-date-has-to-agree", label: "Cross-Dating: Every Date Has To Agree", sub: true }
  - { href: "#the-escalation-ladder", label: "The Escalation Ladder" }
  - { href: "#what-changes-hands-with-the-answer", label: "What Changes Hands With The Answer" }
...
On a Gibson from about 1961 to 1969, the serial is weaker. The company reused and duplicated ranges, so one number can point at two, three, or even four years. You close it with pot codes, pickups, tuners, logo, and hardware. The [Gibson serial number guide](/how-to-read-gibson-serial-numbers/) is the chart. The guitar in your hands is still the thing I trust.
...
**Original finish.** The nitrocellulose that left the spray booth, aged in place. Nitro dries thin and glossy, then yellows and checks into fine hairline cracks. A later paint job, even a careful one, is a refin. Collectors pay for the original film.

**Original parts.** Tuners, pickups, bridge, pots, knobs, pickguard, tailpiece. A period-correct replacement is still a replacement. Tuner stamps date the tuners. Because tuners come off with four screws, a correct-era stamp only helps when it agrees with the headstock, the finish, the pots, and the serial.
...
This is the order I run when a guitar is in front of me. Eyes first, screwdriver second. Each step can support a claim. None of them close the whole instrument by themselves.
...
You can decode a serial from a chart. You can't finish a six-figure burst from a chart.
...
Don't pay lab money to answer a serial-chart question. Don't treat a free photo appraisal as a finish certification on a custom color Strat.
...
Finish, pickups, tuners, bridge, frets, and electronics as the factory built them, with nothing replaced or refinished. It's hard to find on a guitar that's been played for sixty years. A refret alone can take it off that list. Say what is original.

<h3 id="how-do-you-tell-if-a-vintage-guitar-has-been-refinished">How Do You Tell If A Vintage Guitar Has Been Refinished?</h3>

Start with wear, checking, cavity paint, and blacklight as a screen. On a Fender custom color, use the factory tells on the [custom color guide](/post/fender-custom-color-authentication-guide/) rather than this page. Old refinishes can fool a blacklight. A later poly over original wood is a different problem than a full strip. When the money is in the film, send photos or take the guitar to a bench. I can't call a film from one photo.

<h3 id="does-a-blacklight-prove-a-finish-is-original">Does A Blacklight Prove A Finish Is Original?</h3>

No. Aged original nitro usually glows greenish or yellowish, so later work can show as a dark patch. Old refinishes can go undetected, poly glows inconsistently, and new nitro hasn't aged enough to glow. I use UV. I don't close a finish on it.

<h3 id="how-much-value-does-a-refinish-cost-you">How Much Value Does A Refinish Cost You?</h3>

Even excellent refinish work commonly reduces a vintage guitar's value by roughly 40 to 50 percent versus a comparable original-finish example. Collectors pay for original nitro and patina. That's a range, and player-grade demand can narrow it. Get a number on the actual guitar before you price a sale or an insurance rider.

<h3 id="what-do-replaced-parts-do-to-value">What Do Replaced Parts Do To Value?</h3>

All-original tends to bring the most, then correct-period parts, then refinished, then modified player-grade. A single replaced tuner drops a guitar into a different tier than a true all-original example. Pickup swaps, extra routing, and refinishes don't all cost the same percentage. Price the guitar you have.

<h3 id="does-a-refret-take-a-guitar-off-all-original-status">Does A Refret Take A Guitar Off All Original Status?</h3>

Yes, on the strict definition. A refret replaces the original frets, so the guitar is no longer all original even when the work is clean and necessary. It's routine maintenance that keeps a vintage guitar playable. Disclose it.

<h3 id="what-does-untouched-solder-look-like">What Does Untouched Solder Look Like?</h3>

The joint in the photo on this page is dull grey, with old flux around it. Later work is often shinier and sits on top of an older joint. On Fender, those joints support a claim that the harness wasn't pulled. On a PAF-era Gibson, grey cover solder is the factory look.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What Does All Original Mean On A Vintage Guitar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Finish, pickups, tuners, bridge, frets, and electronics as the factory built them, with nothing replaced or refinished. It's hard to find on a guitar that's been played for sixty years. A refret alone can take it off that list. Say what is original."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Start with wear, checking, cavity paint, and blacklight as a screen. On a Fender custom color, use the factory tells on the custom color guide rather than this page. Old refinishes can fool a blacklight. A later poly over original wood is a different problem than a full strip. When the money is in the film, send photos or take the guitar to a bench. I can't call a film from one photo."
      }
    },
    {
      "@type": "Question",
      "name": "Does A Blacklight Prove A Finish Is Original?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Aged original nitro usually glows greenish or yellowish, so later work can show as a dark patch. Old refinishes can go undetected, poly glows inconsistently, and new nitro hasn't aged enough to glow. I use UV. I don't close a finish on it."
      }
    },
    {
      "@type": "Question",
      "name": "How Much Value Does A Refinish Cost You?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Even excellent refinish work commonly reduces a vintage guitar's value by roughly 40 to 50 percent versus a comparable original-finish example. Collectors pay for original nitro and patina. That's a range, and player-grade demand can narrow it. Get a number on the actual guitar before you price a sale or an insurance rider."
      }
    },
    {
      "@type": "Question",
      "name": "What Do Replaced Parts Do To Value?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "All-original tends to bring the most, then correct-period parts, then refinished, then modified player-grade. A single replaced tuner drops a guitar into a different tier than a true all-original example. Pickup swaps, extra routing, and refinishes don't all cost the same percentage. Price the guitar you have."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, on the strict definition. A refret replaces the original frets, so the guitar is no longer all original even when the work is clean and necessary. It's routine maintenance that keeps a vintage guitar playable. Disclose it."
      }
    },
    {
      "@type": "Question",
      "name": "What Does Untouched Solder Look Like?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The joint in the photo on this page is dull grey, with old flux around it. Later work is often shinier and sits on top of an older joint. On Fender, those joints support a claim that the harness wasn't pulled. On a PAF-era Gibson, grey cover solder is the factory look."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What If The Neck Date And The Body Date Do Not Match?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "On a Fender, that can be factory. The neck date dates the neck. Finished necks sat in bins, so a neck weeks or months older than the body is common on an original guitar. A neck dated well after the body is the usual sign of a swap. Confirm with pot codes, the serial range, and whether the finish in the pocket matches the rest of the guitar."
      }
    },
    {
      "@type": "Question",
      "name": "Does A Certificate Of Authenticity Prove Originality?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A certificate is paperwork. It's only as strong as the inspection behind it and the person who signed it. Carter Vintage states that an online appraisal shouldn't be treated as a certification of originality. I treat photo reads the same way. Originality is assessed from the information in hand. A bench inspection can change the conclusion."
      }
    }
  ]
}

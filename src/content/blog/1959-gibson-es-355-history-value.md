...
tags: []
heroImage: "/images/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-cherry-front.jpg"
heroImageAlt: "Front of a 1959 Gibson ES-355 in cherry red with a Bigsby vibrato, split-diamond headstock, and gold hardware, resting in its pink-lined case at Joe's Vintage Guitars."
metaDescription: "The complete vintage 1959 Gibson ES-355 guide: mono ES-355TD versus stereo Vari-tone, split-diamond and ebony specs, serial and FON dating, PAF and Bigsby authentication, refinish and mod red flags, and what a 1959 355 is worth in 2026."
ogImage: "/images/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-cherry-front.jpg"
---
<nav class="es355-nav-sidebar" id="es355NavSidebar" aria-label="Article section navigation">
  <div class="es355-nav-header"><strong>ES-355 Guide</strong></div>
  <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});return false;" class="es355-nav-link top">&uarr; Top of Page</a>
  <div class="es355-nav-label">The Guitar</div>
  <a href="#es355-what" class="es355-nav-link"><span class="es355-nav-dot"></span>The Short Version</a>
  <a href="#es355-lineup" class="es355-nav-link"><span class="es355-nav-dot"></span>Flagship of the 335 Family</a>
  <a href="#es355-mono-stereo" class="es355-nav-link"><span class="es355-nav-dot"></span>Mono or Stereo</a>
  <a href="#es355-body" class="es355-nav-link"><span class="es355-nav-dot"></span>The Body</a>
  <a href="#es355-neck" class="es355-nav-link"><span class="es355-nav-dot"></span>Neck, Ebony &amp; Split-Diamond</a>
  <a href="#es355-electronics" class="es355-nav-link"><span class="es355-nav-dot"></span>Gold-Cover PAFs</a>
  <a href="#es355-hardware" class="es355-nav-link"><span class="es355-nav-dot"></span>Bigsby, Grovers &amp; Gold</a>
  <a href="#es355-finish" class="es355-nav-link"><span class="es355-nav-dot"></span>Cherry &amp; Honest Wear</a>
  <a href="#es355-timeline" class="es355-nav-link"><span class="es355-nav-dot"></span>Year by Year</a>
  <a href="#es355-players" class="es355-nav-link"><span class="es355-nav-dot"></span>Who Played One</a>
  <div class="es355-nav-label">Dating &amp; Authentication</div>
  <a href="#es355-dating" class="es355-nav-link"><span class="es355-nav-dot"></span>Dating Your ES-355</a>
  <a href="#es355-authenticate" class="es355-nav-link"><span class="es355-nav-dot"></span>Reading One Like a Dealer</a>
  <a href="#es355-mods" class="es355-nav-link"><span class="es355-nav-dot"></span>Mods and Red Flags</a>
  <a href="#es355-checklist" class="es355-nav-link"><span class="es355-nav-dot"></span>The Checklist</a>
  <div class="es355-nav-label">Value</div>
  <a href="#es355-value" class="es355-nav-link"><span class="es355-nav-dot"></span>What It Is Worth</a>
  <a href="#es355-selling" class="es355-nav-link"><span class="es355-nav-dot"></span>Thinking of Selling</a>
  <a href="#es355-faq" class="es355-nav-link"><span class="es355-nav-dot"></span>FAQ</a>
</nav>
...
<button class="es355-nav-btn" id="es355NavBtn" onclick="toggleEs355Nav()" aria-expanded="false" aria-controls="es355NavPanel" type="button">
  <span class="es355-nav-icon">&#9776;</span> Jump To Section
</button>

<div class="es355-nav-panel" id="es355NavPanel" role="navigation" aria-label="Article section navigation">
  <div class="es355-nav-header"><strong>ES-355 Guide</strong></div>
  ...
  <div class="es355-nav-label">The Guitar</div>
  <a href="#es355-what" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>The Short Version</a>
  <a href="#es355-lineup" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Flagship of the 335 Family</a>
  <a href="#es355-mono-stereo" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Mono or Stereo</a>
  <a href="#es355-body" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>The Body</a>
  <a href="#es355-neck" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Neck, Ebony &amp; Split-Diamond</a>
  <a href="#es355-electronics" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Gold-Cover PAFs</a>
  <a href="#es355-hardware" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Bigsby, Grovers &amp; Gold</a>
  <a href="#es355-finish" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Cherry &amp; Honest Wear</a>
  <a href="#es355-timeline" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Year by Year</a>
  <a href="#es355-players" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Who Played One</a>
  <div class="es355-nav-label">Dating &amp; Authentication</div>
  <a href="#es355-dating" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Dating Your ES-355</a>
  <a href="#es355-authenticate" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Reading One Like a Dealer</a>
  <a href="#es355-mods" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Mods and Red Flags</a>
  <a href="#es355-checklist" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>The Checklist</a>
  <div class="es355-nav-label">Value</div>
  <a href="#es355-value" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>What It Is Worth</a>
  <a href="#es355-selling" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>Thinking of Selling</a>
  <a href="#es355-faq" onclick="closeEs355Nav()" class="es355-nav-link"><span class="es355-nav-dot"></span>FAQ</a>
</div>
...
![Split-diamond pearl headstock inlay and gold Gibson logo on a black multi-bound headstock of a 1959 Gibson ES-355.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-split-diamond-headstock.jpg)
...
![Multi-ply cream and black body binding on the cutaway of a 1959 Gibson ES-355 in cherry, next to a bound f-hole.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-multi-ply-binding.jpg)
...
![Ebony fingerboard with pearl block inlays and multi-ply binding on the neck of a 1959 Gibson ES-355 in cherry.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-neck-block-inlays.jpg)
...
![Two gold-cover PAF humbuckers with the gold plating worn to bare nickel on a 1959 Gibson ES-355, with a tortoise pickguard and heavy finish checking.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-paf-humbuckers.jpg)
...
![Gold Grover Rotomatic tuners with the Grover name stamped across the housings on the back of a 1959 Gibson ES-355 headstock, gold plating worn.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-grover-tuners.jpg)
...
![Back of a 1959 Gibson ES-355 in cherry showing an original faded finish with honest wear and fine lacquer checking.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-cherry-back.jpg)
...
![Full back of a 1959 Gibson ES-355 in cherry standing in its open brown case with pink lining.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-back-in-case.jpg)
...
![Full back of a 1959 Gibson ES-355 and its headstock in the case, showing the plain cherry back of the neck with no volute.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-full-back-case.jpg)
...
![Bound f-hole and multi-ply body binding on a 1959 Gibson ES-355 in cherry, with honest lacquer checking across the top.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-cutaway-f-hole.jpg)
...
![Neck heel and multi-ply binding at the body joint of a 1959 Gibson ES-355 in cherry.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-neck-heel.jpg)
...
![Original brown hardshell case for a 1959 Gibson ES-355 with its pink plush lining.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-brown-case.jpg)
...
![Exterior of the original brown hardshell case for a 1959 Gibson ES-355.](../../assets/blog/1959-gibson-es-355-history-value/1959-gibson-es-355-case-exterior.jpg)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the difference between a Gibson ES-355 and an ES-335?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "They share the same body and center-block construction, but the 355 was the top-of-the-line model and the 335 was the entry point. The 355 has an ebony fingerboard with pearl block inlays, a split-diamond headstock inlay, gold hardware, fancier multi-ply binding, bound f-holes, a Bigsby vibrato standard, and cherry finish, and it was offered with stereo Vari-tone electronics. The 335 has a rosewood board with dot inlays, nickel hardware, single-ply binding, unbound f-holes, and simple mono wiring. In 1959 the 355 cost about double a base 335."
      }
    },
    {
      "@type": "Question",
      "name": "What is the difference between an ES-355TD and an ES-355TD-SV?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The ES-355TD is the mono version, with two volumes, two tones, a three-way toggle, and one output jack, wired just like a 335. The ES-355TD-SV is the Stereo Vari-tone version, which sends the two pickups to separate amplifier channels in stereo and adds a six-position Vari-tone rotary switch that filters the tone. Mono is the simpler and, today, more desirable configuration."
      }
    },
    {
      "@type": "Question",
      "name": "How can I tell what year my Gibson ES-355 is?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Start with the features, then confirm with the numbers. Rounded cutaway horns, a long pickguard, a big neck, and gold Grover tuners point to the late 1950s. On a 1958 to 1960 guitar the serial is on the orange oval label inside the body, readable through the bass-side f-hole, as an A followed by five digits, and 1959 runs roughly A-28881 to A-32284. There is no serial on the back of the headstock until 1961. The Factory Order Number stamped inside uses S for 1959, and it can read a year earlier than the serial, which is normal."
      }
    ...
    {
      "@type": "Question",
      "name": "Is my 1959 Gibson ES-355 worth more if it is mono or stereo?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Mono. Even though stereo Vari-tone was the standard catalog spec, most players never liked the stereo rig and the tone-scooping Vari-tone, so today a mono ES-355TD is the more desirable and more valuable configuration. A mono 355 is essentially a dressed-up 335 with the wiring players actually want."
      }
    },
    {
      "@type": "Question",
      "name": "Should a 1959 ES-355 have a Bigsby or a stop-tailpiece?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A Bigsby. The 355 came standard with a gold Bigsby vibrato in 1959, so a Bigsby is correct and expected, not an aftermarket add. A genuine factory stop-tail 355 does exist but is a special-order rarity, and it is actually worth more than a Bigsby guitar. Beware of a Bigsby that was removed and replaced with a stop-tail, which you can spot by filled Bigsby mounting holes near the tail."
      }
    },
    {
      "@type": "Question",
      "name": "What is a 1959 Gibson ES-355 worth?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In mid-2026, an all-original, excellent 1959 ES-355TD mono in cherry generally runs from about 30,000 to 45,000 dollars, with the rare factory mono stop-tail higher, and an all-original stereo Vari-tone version softer, roughly 22,000 to 38,000 dollars. Refinishing, replaced pickups, a headstock repair, or a stereo-to-mono conversion each take a substantial bite out of that. The market is thin and asking prices run ahead of sold prices, so the only real way to know is to have your specific guitar appraised."
      }
    },
    {
      "@type": "Question",
      "name": "Why is a fancy ES-355 worth less than a plain ES-335 dot-neck?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Because players and collectors prize the 335 dot-neck's simple mono tone, stop-tailpiece, and clean looks, while the 355's stereo Vari-tone electronics are seen as gimmicky and most 355s carry a Bigsby rather than a stop-tail. A clean 1959 335 dot-neck can run 45,000 to 80,000 dollars and up, while a 1959 355 sits in the twenties to fifties. The one exception is the rare factory mono 355, which the market rewards for having the simple tone players want."
      }
    }
  ]
}
...
<style>
  /* Floating in-page nav for this post (es355-nav), ported from the es5-nav pattern. */
  .es355-nav-btn { display: none; position: fixed; left: 24px; bottom: 1.5rem; top: auto; right: auto; z-index: 9999; background: #b93c15; color: #fff; border: none; border-radius: 50px; padding: 13px 22px; font-family: var(--font-display, Oswald), sans-serif; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; cursor: pointer; box-shadow: 0 4px 20px rgba(185,60,21,.45); align-items: center; gap: 8px; transition: background .2s, box-shadow .2s, transform .2s; }
  .es355-nav-btn:hover { background: #9a3010; box-shadow: 0 6px 28px rgba(185,60,21,.55); transform: translateY(-2px); }
  .es355-nav-btn.open { background: #7b1d1d; }
  .es355-nav-icon { font-size: 15px; line-height: 1; transition: transform .3s; }
  .es355-nav-btn.open .es355-nav-icon { transform: rotate(45deg); }
  .es355-nav-sidebar { position: fixed; top: 170px; right: 24px; z-index: 25; width: 260px; max-height: calc(100vh - 200px); overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,.12); display: none; flex-direction: column; transition: opacity .25s; }
  .es355-nav-sidebar.es355-nav-hidden { opacity: 0; pointer-events: none; }
  .es355-nav-panel { position: fixed; left: 24px; bottom: 5rem; top: auto; right: auto; z-index: 9998; width: 300px; max-height: 70vh; overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 14px; box-shadow: 0 12px 40px rgba(0,0,0,.18); flex-direction: column; display: none; }
  .es355-nav-panel.open { display: flex; }
  .es355-nav-header { background: #7b1d1d; padding: 16px 18px; border-radius: 10px 10px 0 0; flex-shrink: 0; }
  .es355-nav-header strong { display: block; color: #fff; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .1em; }
  .es355-nav-label { background: #f4f0e8; padding: 7px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 10px; font-weight: 700; color: #7a6b5d; text-transform: uppercase; letter-spacing: .1em; border-bottom: 1px solid #e0dacc; flex-shrink: 0; }
  .blog-prose .es355-nav-link, .blog-prose .es355-nav-link:link, .blog-prose .es355-nav-link:visited { display: flex; padding: 10px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; color: #4a3427 !important; text-decoration: none !important; text-transform: uppercase; letter-spacing: .04em; border-bottom: 1px solid #f0ebe3; transition: background .15s, color .15s; align-items: center; gap: 8px; }
  .blog-prose .es355-nav-link:last-child { border-bottom: none; }
  .blog-prose .es355-nav-link:focus, .blog-prose .es355-nav-link:hover { background: #f9f7f2; color: #b93c15 !important; text-decoration: none !important; }
  .blog-prose .es355-nav-link.top, .blog-prose .es355-nav-link.top:link, .blog-prose .es355-nav-link.top:visited { background: #fff8f0; color: #b93c15 !important; border-bottom: 2px solid #e0dacc; text-decoration: none !important; }
  .blog-prose .es355-nav-link.top:hover { background: #fef0e6; }
  .es355-nav-dot { width: 6px; height: 6px; border-radius: 50%; background: #b93c15; flex-shrink: 0; }
  @media (min-width: 1100px) {
    .es355-nav-sidebar { display: flex; }
    .es355-nav-btn { display: none !important; }
    .es355-nav-panel { display: none !important; }
  ...
  @media (max-width: 1099.98px) {
    .es355-nav-sidebar { display: none !important; }
    .es355-nav-btn { display: flex; }
  }
  @media (max-width: 480px) {
    .es355-nav-panel { left: 16px; bottom: 5rem; width: calc(100vw - 32px); max-width: 320px; }
  }
...
<script>
  function toggleEs355Nav() {
    var btn = document.getElementById('es355NavBtn');
    var panel = document.getElementById('es355NavPanel');
    if (!btn || !panel) return;
    if (panel.classList.contains('open')) { closeEs355Nav(); }
    else { panel.classList.add('open'); btn.classList.add('open'); btn.setAttribute('aria-expanded', 'true'); }
  }
  function closeEs355Nav() {
    var btn = document.getElementById('es355NavBtn');
    var panel = document.getElementById('es355NavPanel');
    if (!btn || !panel) return;
  ...
  document.addEventListener('click', function (e) {
    ...
    var panel = document.getElementById('es355NavPanel');
    if (!btn || !panel) return;
    if (!btn.contains(e.target) && !panel.contains(e.target)) closeEs355Nav();
  });
  (function () {
    function initEs355Fade() {
      var contact = document.getElementById('contact');
      var sidebar = document.getElementById('es355NavSidebar');
      if (contact && sidebar && 'IntersectionObserver' in window) {
        new IntersectionObserver(function (entries) {
          sidebar.classList.toggle('es355-nav-hidden', entries[0].isIntersecting);
        }).observe(contact);
      }
    }
    if (document.readyState === 'loading') { document.addEventListener('DOMContentLoaded', initEs355Fade); }
    else { initEs355Fade(); }
  })();
</script>

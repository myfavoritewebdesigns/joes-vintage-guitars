...
tags: []
heroImage: "/images/blog/fender-mustang-history-value/1971-fender-mustang-competition-blue-front.jpg"
heroImageAlt: "Front of a 1971 Fender Competition Mustang in Competition Blue with seafoam racing stripes, a pearloid pickguard, and the Dynamic Vibrato, in its original orange-lined case. We buy vintage Fender Mustangs nationwide at Joe's Vintage Guitars."
metaDescription: "The complete vintage Fender Mustang guide: year-by-year specs, the Competition finishes, how to spot a refinish or wrong parts, serial number dating, and what a Mustang is worth today."
ogImage: "/images/blog/fender-mustang-history-value/1971-fender-mustang-competition-blue-front.jpg"
---
<nav class="fmg-nav-sidebar" id="fmgNavSidebar" aria-label="Article section navigation">
  <div class="fmg-nav-header"><strong>Mustang Guide</strong></div>
  <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});return false;" class="fmg-nav-link top">&uarr; Top of Page</a>
  <div class="fmg-nav-label">The Guitar</div>
  <a href="#fmg-what" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Short Version</a>
  <a href="#fmg-family" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Student Line</a>
  <a href="#fmg-built" class="fmg-nav-link"><span class="fmg-nav-dot"></span>How It Was Built</a>
  <a href="#fmg-switching" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Pickups and Switching</a>
  <a href="#fmg-vibrato" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Dynamic Vibrato</a>
  <a href="#fmg-timeline" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Year by Year</a>
  <a href="#fmg-competition" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Competition Mustangs</a>
  <a href="#fmg-cobain" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Cobain and After</a>
  <div class="fmg-nav-label">Dating &amp; Authentication</div>
  <a href="#fmg-dating" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Dating Your Mustang</a>
  <a href="#fmg-authenticate" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Authentication</a>
  <a href="#fmg-mods" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Mods and Red Flags</a>
  <a href="#fmg-checklist" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Checklist</a>
  <div class="fmg-nav-label">Value</div>
  <a href="#fmg-reissue" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Vintage or Reissue</a>
  <a href="#fmg-value" class="fmg-nav-link"><span class="fmg-nav-dot"></span>What It Is Worth</a>
  <a href="#fmg-selling" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Thinking of Selling</a>
  <a href="#fmg-faq" class="fmg-nav-link"><span class="fmg-nav-dot"></span>FAQ</a>
</nav>

<button class="fmg-nav-btn" id="fmgNavBtn" onclick="toggleFmgNav()" aria-expanded="false" aria-controls="fmgNavPanel" type="button">
  <span class="fmg-nav-icon">&#9776;</span> Jump To Section
</button>

<div class="fmg-nav-panel" id="fmgNavPanel" role="navigation" aria-label="Article section navigation">
  <div class="fmg-nav-header"><strong>Mustang Guide</strong></div>
  <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});closeFmgNav();return false;" class="fmg-nav-link top">&uarr; Top of Page</a>
  <div class="fmg-nav-label">The Guitar</div>
  <a href="#fmg-what" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Short Version</a>
  <a href="#fmg-family" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Student Line</a>
  <a href="#fmg-built" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>How It Was Built</a>
  <a href="#fmg-switching" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Pickups and Switching</a>
  <a href="#fmg-vibrato" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Dynamic Vibrato</a>
  <a href="#fmg-timeline" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Year by Year</a>
  <a href="#fmg-competition" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Competition Mustangs</a>
  <a href="#fmg-cobain" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Cobain and After</a>
  <div class="fmg-nav-label">Dating &amp; Authentication</div>
  <a href="#fmg-dating" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Dating Your Mustang</a>
  <a href="#fmg-authenticate" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Authentication</a>
  <a href="#fmg-mods" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Mods and Red Flags</a>
  <a href="#fmg-checklist" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>The Checklist</a>
  <div class="fmg-nav-label">Value</div>
  <a href="#fmg-reissue" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Vintage or Reissue</a>
  <a href="#fmg-value" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>What It Is Worth</a>
  <a href="#fmg-selling" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>Thinking of Selling</a>
  <a href="#fmg-faq" onclick="closeFmgNav()" class="fmg-nav-link"><span class="fmg-nav-dot"></span>FAQ</a>
</div>
...
![Front of a 1965 Fender Mustang in Dakota Red showing two angled single-coil pickups, two three-position slide switches, a white pearloid pickguard, and the chrome Dynamic Vibrato.](../../assets/blog/fender-mustang-history-value/1965-fender-mustang-dakota-red-front.jpg)
...
![Close-up of the chrome Fender Dynamic Vibrato bridge and tailpiece on a 1965 Mustang, engraved Fender Dynamic Vibrato Pat. Pend.](../../assets/blog/fender-mustang-history-value/fender-mustang-dynamic-vibrato-pat-pend.jpg)
...
![Front of a 1972 Fender Mustang in three-color sunburst with a pearloid pickguard and the Dynamic Vibrato.](../../assets/blog/fender-mustang-history-value/1972-fender-mustang-sunburst-pearloid-pickguard.jpg)
...
![Early 1960s Fender Mustang in Olympic White with a tortoiseshell celluloid pickguard, leaning on a vintage Fender amp.](../../assets/blog/fender-mustang-history-value/1960s-fender-mustang-olympic-white-tortoiseshell-pickguard.jpg)
...
![Headstock of a 1971 Fender Mustang showing the large CBS-era headstock with the bold black Fender logo and Mustang model name.](../../assets/blog/fender-mustang-history-value/1971-fender-mustang-cbs-headstock-logo.jpg)
...
![Front of a 1972 Fender Competition Mustang in Competition Red with a racing stripe and heavy honest player wear, next to a Fender Princeton amp.](../../assets/blog/fender-mustang-history-value/fender-competition-mustang-red-racing-stripes.jpg)
...
![Back of a mid-1960s Fender Mustang neck showing the large F neck plate stamped with serial number 108216.](../../assets/blog/fender-mustang-history-value/fender-mustang-f-neck-plate-serial-number.jpg)
...
![Back of a 1972 Fender Competition Mustang neck showing the F neck plate stamped with serial number 340349.](../../assets/blog/fender-mustang-history-value/fender-mustang-f-plate-serial-340349.jpg)
...
![Back of a vintage Fender Mustang headstock showing the maple neck, string tree, and tuners.](../../assets/blog/fender-mustang-history-value/vintage-fender-mustang-headstock-back-tuners.jpg)
...
![Back of a 1972 Fender Competition Mustang in Competition Red showing heavy finish wear and honest player condition.](../../assets/blog/fender-mustang-history-value/fender-competition-mustang-red-back-player-wear.jpg)
...
![Interior of a vintage Fender hardshell guitar case with orange plush lining and a Milano Music Center, Mesa, Arizona dealer sticker.](../../assets/blog/fender-mustang-history-value/fender-mustang-case-milano-music-center-mesa-arizona.jpg)
...
![Original Fender Competition Mustang owner's manual booklet lying on the orange plush lining of a vintage case.](../../assets/blog/fender-mustang-history-value/fender-competition-mustang-owners-manual.jpg)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What years were Fender Mustangs made?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The original Fender Mustang ran from 1964 to 1982. Fender reissued the model in Japan starting around 1990, and it remains in production today in various forms, so the key distinction for value is between a vintage original from the 1964 to 1982 run and a later reissue."
      }
    },
    {
      "@type": "Question",
      "name": "How can I tell what year my Fender Mustang is?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Start with the neck plate serial number and match it to a known range: the pre-CBS L-series is 1964 to 1965, and the large F-plate runs from late 1965 through the rest of the vintage era. Then confirm the year with the features, including the headstock size, the logo style, the Offset Contour Body decal, the vibrato engraving (Pat. Pend. early, a patent number from about 1967), and the pickguard. The most reliable date comes from the neck-heel stamp and the potentiometer date codes, which a professional appraisal can read for you."
      }
    ...
    {
      "@type": "Question",
      "name": "What is a Competition Mustang?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A Competition Mustang is a Mustang finished in Fender's Competition package, offered from about 1968 or 1969 to 1973. It has a diagonal racing stripe across the body, a pearloid pickguard, and, on early examples, a matching painted headstock. The colors were Competition Red, Competition Blue, and Competition Orange. Competition Mustangs are the most collectible vintage Mustangs, with Orange the rarest and Blue carrying a premium from the Kurt Cobain association."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What is the difference between the 22.5 inch and 24 inch scale Mustang?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Mustang was offered in a 22.5 inch short scale and a 24 inch medium scale. The 24 inch became the standard and is far more common, while a genuine 22.5 inch example is the less usual find. The shorter scale means lower string tension and an easier reach, which is part of why the Mustang appealed to younger players and later to anyone who liked its slinky feel. Fender's nut-width letter code, A for the narrow nut and B for the wider one, is separate from the scale but shows up in the neck stamp."
      }
    },
    {
      "@type": "Question",
      "name": "What do the two slide switches on a Mustang do?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Each slide switch controls one pickup and has three positions: on, off, and on with the phase reversed. Throw both switches the same way and the pickups play together in phase for the normal Mustang sound. Throw them opposite ways and the pickups run out of phase for a thin, hollow tone. Put a switch in the center and that pickup is off. The stock circuit is wired in parallel, not series, so a Mustang wired for series has been modified."
      }
    },
    {
      "@type": "Question",
      "name": "Did Kurt Cobain play a Fender Mustang?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Kurt Cobain played left-handed Mustangs through Nirvana's peak years, most famously a 1969 Competition model in Lake Placid Blue, and his love of the Mustang and the Jaguar led to the Fender Jag-Stang hybrid. His own 1969 Competition Mustang later sold at auction for millions of dollars. That value belongs to his specific guitar and does not transfer to other Mustangs, but the association lifted the whole Competition Mustang market."
      }
    },
    {
      "@type": "Question",
      "name": "Is a reissue or Japanese Mustang worth as much as a vintage one?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Reissues are good guitars, but they are worth a fraction of a vintage original. Japanese-built reissues from 1990 on are marked Made in Japan or Crafted in Japan and carry modern serials and pots, and modern U.S. and Mexican Mustangs have updated radii and switching. A real 1960s or early-1970s U.S. Mustang with an L-series or F-plate serial is a different instrument at a different price, so confirming which one you have is the whole point of an appraisal."
      }
    }
  ]
}
...
<style>
  /* Floating in-page nav for this post (fmg-nav), ported from the Duo Jet gdj-nav pattern. */
  .fmg-nav-btn { display: none; position: fixed; left: 24px; bottom: 1.5rem; top: auto; right: auto; z-index: 9999; background: #b93c15; color: #fff; border: none; border-radius: 50px; padding: 13px 22px; font-family: var(--font-display, Oswald), sans-serif; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; cursor: pointer; box-shadow: 0 4px 20px rgba(185,60,21,.45); align-items: center; gap: 8px; transition: background .2s, box-shadow .2s, transform .2s; }
  .fmg-nav-btn:hover { background: #9a3010; box-shadow: 0 6px 28px rgba(185,60,21,.55); transform: translateY(-2px); }
  .fmg-nav-btn.open { background: #7b1d1d; }
  .fmg-nav-icon { font-size: 15px; line-height: 1; transition: transform .3s; }
  .fmg-nav-btn.open .fmg-nav-icon { transform: rotate(45deg); }
  .fmg-nav-sidebar { position: fixed; top: 170px; right: 24px; z-index: 25; width: 260px; max-height: calc(100vh - 200px); overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,.12); display: none; flex-direction: column; transition: opacity .25s; }
  .fmg-nav-sidebar.fmg-nav-hidden { opacity: 0; pointer-events: none; }
  .fmg-nav-panel { position: fixed; left: 24px; bottom: 5rem; top: auto; right: auto; z-index: 9998; width: 300px; max-height: 70vh; overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 14px; box-shadow: 0 12px 40px rgba(0,0,0,.18); flex-direction: column; display: none; }
  .fmg-nav-panel.open { display: flex; }
  .fmg-nav-header { background: #7b1d1d; padding: 16px 18px; border-radius: 10px 10px 0 0; flex-shrink: 0; }
  .fmg-nav-header strong { display: block; color: #fff; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .1em; }
  .fmg-nav-label { background: #f4f0e8; padding: 7px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 10px; font-weight: 700; color: #7a6b5d; text-transform: uppercase; letter-spacing: .1em; border-bottom: 1px solid #e0dacc; flex-shrink: 0; }
  .blog-prose .fmg-nav-link, .blog-prose .fmg-nav-link:link, .blog-prose .fmg-nav-link:visited { display: flex; padding: 10px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; color: #4a3427 !important; text-decoration: none !important; text-transform: uppercase; letter-spacing: .04em; border-bottom: 1px solid #f0ebe3; transition: background .15s, color .15s; align-items: center; gap: 8px; }
  .blog-prose .fmg-nav-link:last-child { border-bottom: none; }
  .blog-prose .fmg-nav-link:focus, .blog-prose .fmg-nav-link:hover { background: #f9f7f2; color: #b93c15 !important; text-decoration: none !important; }
  .blog-prose .fmg-nav-link.top, .blog-prose .fmg-nav-link.top:link, .blog-prose .fmg-nav-link.top:visited { background: #fff8f0; color: #b93c15 !important; border-bottom: 2px solid #e0dacc; text-decoration: none !important; }
  .blog-prose .fmg-nav-link.top:hover { background: #fef0e6; }
  .fmg-nav-dot { width: 6px; height: 6px; border-radius: 50%; background: #b93c15; flex-shrink: 0; }
  @media (min-width: 1100px) {
    .fmg-nav-sidebar { display: flex; }
    .fmg-nav-btn { display: none !important; }
    .fmg-nav-panel { display: none !important; }
  ...
  @media (max-width: 1099.98px) {
    .fmg-nav-sidebar { display: none !important; }
    .fmg-nav-btn { display: flex; }
  }
  @media (max-width: 480px) {
    .fmg-nav-panel { left: 16px; bottom: 5rem; width: calc(100vw - 32px); max-width: 320px; }
  }
...
<script>
  function toggleFmgNav() {
    var btn = document.getElementById('fmgNavBtn');
    var panel = document.getElementById('fmgNavPanel');
    if (!btn || !panel) return;
    if (panel.classList.contains('open')) { closeFmgNav(); }
    else { panel.classList.add('open'); btn.classList.add('open'); btn.setAttribute('aria-expanded', 'true'); }
  }
  function closeFmgNav() {
    var btn = document.getElementById('fmgNavBtn');
    var panel = document.getElementById('fmgNavPanel');
    if (!btn || !panel) return;
  ...
  document.addEventListener('click', function (e) {
    ...
    var panel = document.getElementById('fmgNavPanel');
    if (!btn || !panel) return;
    if (!btn.contains(e.target) && !panel.contains(e.target)) closeFmgNav();
  });
  (function () {
    function initFmgFade() {
      var contact = document.getElementById('contact');
      var sidebar = document.getElementById('fmgNavSidebar');
      if (contact && sidebar && 'IntersectionObserver' in window) {
        new IntersectionObserver(function (entries) {
          sidebar.classList.toggle('fmg-nav-hidden', entries[0].isIntersecting);
        }).observe(contact);
      }
    }
    if (document.readyState === 'loading') { document.addEventListener('DOMContentLoaded', initFmgFade); }
    else { initFmgFade(); }
  })();
</script>

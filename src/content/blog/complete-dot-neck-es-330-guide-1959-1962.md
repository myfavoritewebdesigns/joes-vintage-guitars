...
By 1958, Gibson had already launched the semi-hollow ES-335. Built around a solid maple center block, the 335 changed what a thinline electric could do, and it sold strongly at its price point. But that price point was the problem. Gibson needed a companion model that shared the thinline silhouette without the cost of center-block construction. That model was the **ES-330**, introduced officially in **1959** as a direct replacement for the **ES-225T** (single pickup) and **ES-225TD** (two pickup), both of which were full-depth, single-cutaway archtops that had been in the catalog since 1952. Where the 225s carried a traditional full-depth hollowbody format, the ES-330 moved the concept into Gibson's new **double-cutaway thinline** body. Same silhouette as the ES-335, but fully hollow and priced for the working player rather than the studio professional. The two-pickup version was designated the **ES-330TD**, with TD standing for *Thinline Double* (two pickups). The single-pickup model was the **ES-330T**, with T standing for *Thinline*. Both are commonly referred to today as just "ES-330."
...
The ES-330 in the dot-neck era uses a **rosewood fretboard**, specifically **Brazilian rosewood** (*Dalbergia nigra*), the dense, oil-rich species that Gibson sourced exclusively during this period before Indian rosewood became standard in the late 1960s. The color ranges from chocolate brown to near-black on many examples, with tight, uniform grain and a naturally oily surface that needs no finish. On the finest 1959 examples in particular, the Brazilian rosewood can be so dark and close-grained that it approaches the appearance of ebony. Experienced collectors specifically seek this out, and it serves as a meaningful indicator of wood quality and age. The fretboard radius is **12 inches** on virtually all examples. The nut width is **1 11/16 inches** (approximately 42.8mm), which was Gibson's standard electric nut width throughout this period.

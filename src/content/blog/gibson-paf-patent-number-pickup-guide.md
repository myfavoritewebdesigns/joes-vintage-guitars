---
title: "Gibson PAF and Patent Number Pickups: History, Authentication, and Value"
pubDate: "2026-07-13T12:00:00"
modified: "2026-07-13T12:00:00"
excerpt: "The Gibson PAF humbucker is the most valuable two ounces of wire and metal in the guitar world, and the patent number pickup that followed it is the best bargain. This guide covers the whole story: how Seth Lover invented the humbucker, how the pickup changed from 1957 through the 1970s, every authentication point we check on the bench, and what these pickups are really worth. It also explains, in plain terms, why you should never take one apart to find out."
category: "specific-model-highlights"
categoryName: "Specific Model Highlights"
tags: []
heroImage: "/images/blog/gibson-paf-patent-number-pickup-guide/gibson-paf-sticker-oxidized-solder-joints.jpg"
heroImageAlt: "Underside of an original Gibson PAF humbucker showing the Patent Applied For sticker, aged solder joints, and heavy oxidation on the nickel silver baseplate. We buy vintage Gibson guitars and pickups nationwide at Joe's Vintage Guitars."
metaDescription: "The complete Gibson PAF and patent number pickup guide: history, stickers, magnets, bobbins, ring stamps, every authentication tell, current values, and why you should never open one."
ogImage: "/images/blog/gibson-paf-patent-number-pickup-guide/gibson-paf-sticker-oxidized-solder-joints.jpg"
---
<nav class="paf-nav-sidebar" id="pafNavSidebar" aria-label="Article section navigation">
  <div class="paf-nav-header"><strong>PAF Guide</strong></div>
  <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});return false;" class="paf-nav-link top">&uarr; Top of Page</a>
  <div class="paf-nav-label">The Pickup</div>
  <a href="#paf-what" class="paf-nav-link"><span class="paf-nav-dot"></span>The Short Version</a>
  <a href="#paf-warning" class="paf-nav-link"><span class="paf-nav-dot"></span>Do Not Open It</a>
  <a href="#paf-history" class="paf-nav-link"><span class="paf-nav-dot"></span>The Invention</a>
  <a href="#paf-timeline" class="paf-nav-link"><span class="paf-nav-dot"></span>PAF to T-Top Timeline</a>
  <a href="#paf-anatomy" class="paf-nav-link"><span class="paf-nav-dot"></span>What Is Inside</a>
  <a href="#paf-sound" class="paf-nav-link"><span class="paf-nav-dot"></span>Why They Sound Special</a>
  <a href="#paf-players" class="paf-nav-link"><span class="paf-nav-dot"></span>The Legend Makers</a>
  <div class="paf-nav-label">Authentication</div>
  <a href="#paf-guitar" class="paf-nav-link"><span class="paf-nav-dot"></span>Start with the Guitar</a>
  <a href="#paf-covers" class="paf-nav-link"><span class="paf-nav-dot"></span>Covers and Solder</a>
  <a href="#paf-sticker" class="paf-nav-link"><span class="paf-nav-dot"></span>Reading the Sticker</a>
  <a href="#paf-base" class="paf-nav-link"><span class="paf-nav-dot"></span>Baseplate and Screws</a>
  <a href="#paf-rings" class="paf-nav-link"><span class="paf-nav-dot"></span>Rings and Stamps</a>
  <a href="#paf-electric" class="paf-nav-link"><span class="paf-nav-dot"></span>Meter and Magnet</a>
  <a href="#paf-open" class="paf-nav-link"><span class="paf-nav-dot"></span>Already-Open Pickups</a>
  <a href="#paf-fakes" class="paf-nav-link"><span class="paf-nav-dot"></span>Fakes and Re-Stickers</a>
  <a href="#paf-checklist" class="paf-nav-link"><span class="paf-nav-dot"></span>The Checklist</a>
  <div class="paf-nav-label">Value</div>
  <a href="#paf-value" class="paf-nav-link"><span class="paf-nav-dot"></span>What They Are Worth</a>
  <a href="#paf-factors" class="paf-nav-link"><span class="paf-nav-dot"></span>What Moves the Price</a>
  <a href="#paf-selling" class="paf-nav-link"><span class="paf-nav-dot"></span>Thinking of Selling</a>
  <a href="#paf-faq" class="paf-nav-link"><span class="paf-nav-dot"></span>FAQ</a>
</nav>

<button class="paf-nav-btn" id="pafNavBtn" onclick="togglePafNav()" aria-expanded="false" aria-controls="pafNavPanel" type="button">
  <span class="paf-nav-icon">&#9776;</span> Jump To Section
</button>

<div class="paf-nav-panel" id="pafNavPanel" role="navigation" aria-label="Article section navigation">
  <div class="paf-nav-header"><strong>PAF Guide</strong></div>
  <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});closePafNav();return false;" class="paf-nav-link top">&uarr; Top of Page</a>
  <div class="paf-nav-label">The Pickup</div>
  <a href="#paf-what" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>The Short Version</a>
  <a href="#paf-warning" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Do Not Open It</a>
  <a href="#paf-history" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>The Invention</a>
  <a href="#paf-timeline" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>PAF to T-Top Timeline</a>
  <a href="#paf-anatomy" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>What Is Inside</a>
  <a href="#paf-sound" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Why They Sound Special</a>
  <a href="#paf-players" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>The Legend Makers</a>
  <div class="paf-nav-label">Authentication</div>
  <a href="#paf-guitar" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Start with the Guitar</a>
  <a href="#paf-covers" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Covers and Solder</a>
  <a href="#paf-sticker" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Reading the Sticker</a>
  <a href="#paf-base" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Baseplate and Screws</a>
  <a href="#paf-rings" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Rings and Stamps</a>
  <a href="#paf-electric" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Meter and Magnet</a>
  <a href="#paf-open" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Already-Open Pickups</a>
  <a href="#paf-fakes" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Fakes and Re-Stickers</a>
  <a href="#paf-checklist" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>The Checklist</a>
  <div class="paf-nav-label">Value</div>
  <a href="#paf-value" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>What They Are Worth</a>
  <a href="#paf-factors" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>What Moves the Price</a>
  <a href="#paf-selling" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>Thinking of Selling</a>
  <a href="#paf-faq" onclick="closePafNav()" class="paf-nav-link"><span class="paf-nav-dot"></span>FAQ</a>
</div>

<h2 id="paf-what">The Short Version</h2>
...
![Original Gibson PAF pickup in a 1962 ES-335, flipped over to show the worn Patent Applied For decal on the nickel silver baseplate.](../../assets/blog/gibson-paf-patent-number-pickup-guide/gibson-paf-sticker-1962-es-335.jpg)
...
<h2 id="paf-history">The Invention of the Humbucker</h2>
...
Gibson filed Lover's patent application on June 22, 1955. The new pickup reached production on Gibson's console steel guitars during 1956, and by early 1957 it was on the Spanish electrics that matter to collectors: the Les Paul Goldtop and Custom, the ES-175, the Byrdland, the ES-5, and the rest of the electric line. Our [1957 Les Paul Goldtop guide](/post/1957-les-paul-goldtop-guide/) covers the first year the Les Paul wore them.
...
<h2 id="paf-timeline">From PAF to Patent Number to T-Top</h2>
...
- **1965 to 1967: the T-top.** A new bobbin mold adds a raised letter T on top of each bobbin, and the collector name follows. Gibson phased it in gradually across those years rather than switching cleanly, so guitars from the middle of that window turn up both ways. T-tops keep the patent number sticker into the mid 1970s, then get the number stamped straight into the baseplate, and finally give way to embossed "Gibson" pickups by the early 1980s. T-tops are good pickups and honest vintage parts, but they are ordinary, made for years in big numbers. The 1971 Flying V Medallion in our [Medallion guide](/post/gibson-flying-v-medallion-guide/) wears them, which is factory correct for that guitar.

![Underside of a Gibson patent number pickup showing the black and gold Patent No 2,737,842 sticker on the nickel silver baseplate.](../../assets/blog/gibson-paf-patent-number-pickup-guide/gibson-patent-number-pickup-baseplate.jpg)
...
![Two Gibson T-top humbucker bobbins showing the raised molded T beside the pole holes.](../../assets/blog/gibson-paf-patent-number-pickup-guide/t-top-bobbins.jpg)
...
One more piece of context worth having: the same era that ended the PAF also ended the first golden age of Gibson production. The [shipping totals](/post/gibson-shipping-totals-1948-1979/) tell that story in numbers, and they explain why pickups from a few narrow years carry so much of the market's attention.

<h2 id="paf-anatomy">What Is Inside a PAF</h2>
...
![Inside of an opened Gibson PAF pickup showing the rough sand cast alnico bar magnet, steel keeper bar, pole screws, and maple wood spacer.](../../assets/blog/gibson-paf-patent-number-pickup-guide/paf-alnico-magnet-maple-spacer.jpg)
...
![Undersides of two PAF bobbins showing the pole holes, small square tooling holes, and the maple spacer strip.](../../assets/blog/gibson-paf-patent-number-pickup-guide/paf-bobbin-undersides-square-holes.jpg)
...
![Bare PAF baseplate showing the braided shield lead, the cloth wrapped splice, and the coil leads knotted through the bobbin.](../../assets/blog/gibson-paf-patent-number-pickup-guide/paf-baseplate-braided-lead-splice.jpg)
...
<h2 id="paf-sound">Why PAFs Sound the Way They Do</h2>
...
<h2 id="paf-players">The Players Who Made the Legend</h2>
...
<h2 id="paf-guitar">Start with the Guitar, Not the Pickup</h2>
...
<h2 id="paf-covers">Covers, Solder, and Patina</h2>
...
![Extreme close-up of an aged factory solder joint on a Gibson PAF baseplate with brown flux staining.](../../assets/blog/gibson-paf-patent-number-pickup-guide/aged-factory-solder-joint.jpg)
...
<h2 id="paf-sticker">Reading the Sticker</h2>
...
![Macro photo of an original Patent No 2,737,842 decal showing the yellowed clear carrier film around the black printed rectangle.](../../assets/blog/gibson-paf-patent-number-pickup-guide/patent-number-sticker-close-up.jpg)
...
<h2 id="paf-base">The Baseplate, Screws, and Legs</h2>
...
![Gold plated Gibson patent number pickup from a Les Paul Custom showing factory brushing marks on the nickel silver baseplate.](../../assets/blog/gibson-paf-patent-number-pickup-guide/gold-patent-number-pickup-brushed-baseplate.jpg)
...
![Underside of a patent number pickup showing the protruding pole screw ends, brass and copper toned Phillips bobbin screws, and the mounting leg.](../../assets/blog/gibson-paf-patent-number-pickup-guide/patent-number-baseplate-phillips-screws.jpg)
...
![Close-up of a Gibson humbucker mounting leg showing rough factory tool marks and shear texture.](../../assets/blog/gibson-paf-patent-number-pickup-guide/pickup-mounting-leg-tool-marks.jpg)
...
<h2 id="paf-rings">Mounting Rings and Their Stamps</h2>
...
![M-69 marking molded into the underside of a vintage Gibson pickup mounting ring.](../../assets/blog/gibson-paf-patent-number-pickup-guide/m-69-marking-pickup-ring.jpg)
...
![MR 491 mold marking inside a vintage Gibson pickup ring with the braided pickup lead crossing it.](../../assets/blog/gibson-paf-patent-number-pickup-guide/mr-491-marking-pickup-ring.jpg)
...
![Molded letter stamps inside a vintage Gibson pickup mounting ring.](../../assets/blog/gibson-paf-patent-number-pickup-guide/molded-letter-stamps-pickup-ring.jpg)
...
<h2 id="paf-electric">The Meter and the Magnet: Tests with No Screwdriver</h2>
...
<h2 id="paf-open">If the Covers Are Already Off</h2>
...
![Uncovered Gibson humbucker showing the square tooling hole with the molded circle around it on the slug bobbin.](../../assets/blog/gibson-paf-patent-number-pickup-guide/circle-around-square-bobbin-tooling.jpg)
...
![Close-up through the tooling holes of an uncovered PAF showing the purple brown plain enamel winding wire.](../../assets/blog/gibson-paf-patent-number-pickup-guide/paf-purple-enamel-windings.jpg)
...
<h2 id="paf-fakes">Fakes, Re-Stickers, and Franken-PAFs</h2>
...
<h2 id="paf-checklist">The PAF Authentication Checklist</h2>
...
<h2 id="paf-value">What PAF and Patent Number Pickups Are Worth</h2>
...
<h2 id="paf-selling">Thinking of Selling</h2>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What does PAF stand for on a Gibson pickup?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "PAF stands for Patent Applied For, from the black and gold decal Gibson put on the underside of its humbucking pickups between about 1957 and late 1962, while Seth Lover's 1955 patent application was pending and for years after it was granted in 1959. The nickname became the collector name for the whole first generation of Gibson humbuckers."
      }
    },
    {
      "@type": "Question",
      "name": "How can I tell if my pickup is a real PAF without taking it apart?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Read the outside evidence as one story: the guitar's year and undisturbed harness, a nickel or gold cover with honest aging, dull grey factory solder at the two cover joints, a water slide decal with an aged clear film halo, a nickel silver baseplate with even factory brushing, slotted 5-40 pole screws, a braided single conductor lead at full length, and correct rings. A multimeter reading in the roughly 7.0k to 9.5k ohm vintage band supports the story. If every detail agrees, you very likely have the real thing, and a professional appraisal can confirm it from photos and an in person inspection without opening anything."
      }
    },
    {
      "@type": "Question",
      "name": "Should I open my pickup to check the magnet or bobbin color?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Unsoldering the cover permanently destroys the undisturbed factory solder that collectors pay the biggest premium for, it risks breaking coil wire that is thinner than a hair and sixty years old, and it converts a sealed collector pickup into an opened one at a real cost, often ten to twenty percent of its value. Magnet length, bobbin color, and wire color are expert questions that can be resolved in context, or documented professionally when there is a genuine reason."
      }
    },
    {
      "@type": "Question",
      "name": "What is the difference between a PAF and a patent number pickup?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The sticker, and eventually the details. In late 1962 Gibson replaced the Patent Applied For decal with one reading Patent No 2,737,842, which is actually the number of Les Paul's bridge and tailpiece patent, not the humbucker patent. The earliest patent number pickups are identical to late PAFs inside, with the same purple enamel wire and short alnico five magnet. During 1963 the coil wire changed to orange poly coated wire with consistent winding, around 1965 covers went from nickel to chrome, and by 1966 or 1967 the T-top bobbin arrived."
      }
    },
    {
      "@type": "Question",
      "name": "What is a real PAF worth today?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "As a broad current range for verified originals sold individually: double black PAFs run about 2,500 to 5,500 dollars, zebras about 4,000 to 7,000 dollars, and double whites about 6,000 to 10,000 dollars and beyond, with sealed, undisturbed, documented examples at the top of each range and matched pairs bringing a premium over singles. Patent number pickups run from several hundred dollars for later examples to about 2,200 dollars for the best early ones."
      }
    },
    {
      "@type": "Question",
      "name": "Are patent number and T-top pickups worth anything?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Early patent number pickups from 1962 to 1964 are the smart money of this market, PAF construction at 1,000 to 2,200 dollars. Mid 1960s poly wire examples bring roughly 500 to 1,200 dollars. T-tops from 1966 into the 1970s are honest vintage Gibson pickups in the 200 to 800 dollar range and are factory correct for many valuable late 1960s and 1970s Gibsons."
      }
    },
    {
      "@type": "Question",
      "name": "My pickup has no sticker. Is it fake?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not necessarily. The very first humbuckers of early 1957 left the factory with no decal at all, stickers on later pickups sometimes fell away or were removed, and a missing sticker on an otherwise coherent pickup is a discount rather than a disqualification. It does mean the rest of the evidence has to carry the whole case, so expert verification matters more."
      }
    },
    {
      "@type": "Question",
      "name": "Do double white or zebra PAFs sound different from double black ones?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The bobbin color was a pigment supply accident at Gibson's plastics vendor around 1959 and 1960, and it has no effect on the magnetics or the coil. The enormous price difference is rarity and visual drama. A double black can be the better sounding pickup on any given day."
      }
    }
  ]
}
...
<style>
  /* Floating in-page nav for this post (paf-nav), ported from the esh-nav pattern. */
  .paf-nav-btn { display: none; position: fixed; left: 24px; bottom: 1.5rem; top: auto; right: auto; z-index: 9999; background: #b93c15; color: #fff; border: none; border-radius: 50px; padding: 13px 22px; font-family: var(--font-display, Oswald), sans-serif; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; cursor: pointer; box-shadow: 0 4px 20px rgba(185,60,21,.45); align-items: center; gap: 8px; transition: background .2s, box-shadow .2s, transform .2s; }
  .paf-nav-btn:hover { background: #9a3010; box-shadow: 0 6px 28px rgba(185,60,21,.55); transform: translateY(-2px); }
  .paf-nav-btn.open { background: #7b1d1d; }
  .paf-nav-icon { font-size: 15px; line-height: 1; transition: transform .3s; }
  .paf-nav-btn.open .paf-nav-icon { transform: rotate(45deg); }
  .paf-nav-sidebar { position: fixed; top: 170px; right: 24px; z-index: 25; width: 260px; max-height: calc(100vh - 200px); overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,.12); display: none; flex-direction: column; transition: opacity .25s; }
  .paf-nav-sidebar.paf-nav-hidden { opacity: 0; pointer-events: none; }
  .paf-nav-panel { position: fixed; left: 24px; bottom: 5rem; top: auto; right: auto; z-index: 9998; width: 300px; max-height: 70vh; overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 14px; box-shadow: 0 12px 40px rgba(0,0,0,.18); flex-direction: column; display: none; }
  .paf-nav-panel.open { display: flex; }
  .paf-nav-header { background: #7b1d1d; padding: 16px 18px; border-radius: 10px 10px 0 0; flex-shrink: 0; }
  .paf-nav-header strong { display: block; color: #fff; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .1em; }
  .paf-nav-label { background: #f4f0e8; padding: 7px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 10px; font-weight: 700; color: #7a6b5d; text-transform: uppercase; letter-spacing: .1em; border-bottom: 1px solid #e0dacc; flex-shrink: 0; }
  .blog-prose .paf-nav-link, .blog-prose .paf-nav-link:link, .blog-prose .paf-nav-link:visited { display: flex; padding: 10px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; color: #4a3427 !important; text-decoration: none !important; text-transform: uppercase; letter-spacing: .04em; border-bottom: 1px solid #f0ebe3; transition: background .15s, color .15s; align-items: center; gap: 8px; }
  .blog-prose .paf-nav-link:last-child { border-bottom: none; }
  .blog-prose .paf-nav-link:focus, .blog-prose .paf-nav-link:hover { background: #f9f7f2; color: #b93c15 !important; text-decoration: none !important; }
  .blog-prose .paf-nav-link.top, .blog-prose .paf-nav-link.top:link, .blog-prose .paf-nav-link.top:visited { background: #fff8f0; color: #b93c15 !important; border-bottom: 2px solid #e0dacc; text-decoration: none !important; }
  .blog-prose .paf-nav-link.top:hover { background: #fef0e6; }
  .paf-nav-dot { width: 6px; height: 6px; border-radius: 50%; background: #b93c15; flex-shrink: 0; }
  @media (min-width: 1100px) {
    .paf-nav-sidebar { display: flex; }
    .paf-nav-btn { display: none !important; }
    .paf-nav-panel { display: none !important; }
  ...
  @media (max-width: 1099.98px) {
    .paf-nav-sidebar { display: none !important; }
    .paf-nav-btn { display: flex; }
  }
  @media (max-width: 480px) {
    .paf-nav-panel { left: 16px; bottom: 5rem; width: calc(100vw - 32px); max-width: 320px; }
  }

  /* Warning callout for the do-not-disassemble notice. */
  .paf-warn { background: #fff8f0; border: 2px solid #b93c15; border-radius: 12px; padding: 4px 22px; margin: 1.5rem 0; }
  .paf-warn p { margin: 1em 0; }
  .paf-warn strong { color: #7b1d1d; }
  ...
  /* The small T-top reference photo should not stretch full width. */
  .blog-prose img[src*="t-top-bobbins"] { max-width: 445px; width: 100%; margin-left: auto; margin-right: auto; display: block; }
...
<script>
  function togglePafNav() {
    var btn = document.getElementById('pafNavBtn');
    var panel = document.getElementById('pafNavPanel');
    if (!btn || !panel) return;
    if (panel.classList.contains('open')) { closePafNav(); }
    else { panel.classList.add('open'); btn.classList.add('open'); btn.setAttribute('aria-expanded', 'true'); }
  }
  function closePafNav() {
    var btn = document.getElementById('pafNavBtn');
    var panel = document.getElementById('pafNavPanel');
    if (!btn || !panel) return;
  ...
  document.addEventListener('click', function (e) {
    ...
    var panel = document.getElementById('pafNavPanel');
    if (!btn || !panel) return;
    if (!btn.contains(e.target) && !panel.contains(e.target)) closePafNav();
  });
  (function () {
    function initPafFade() {
      var contact = document.getElementById('contact');
      var sidebar = document.getElementById('pafNavSidebar');
      if (contact && sidebar && 'IntersectionObserver' in window) {
        new IntersectionObserver(function (entries) {
          sidebar.classList.toggle('paf-nav-hidden', entries[0].isIntersecting);
        }).observe(contact);
      }
    }
    if (document.readyState === 'loading') { document.addEventListener('DOMContentLoaded', initPafFade); }
    else { initPafFade(); }
  })();
</script>

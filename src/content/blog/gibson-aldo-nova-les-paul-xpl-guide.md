---
title: "The Gibson Aldo Nova Les Paul (XPL): One of the Rarest Les Pauls of the 1980s"
pubDate: "2026-07-09T12:00:00"
modified: "2026-07-09T12:00:00"
excerpt: "The Gibson Aldo Nova Les Paul is a mid-1980s rarity: a flame-top Les Paul Standard fitted with an Explorer headstock, or XPL, and marked Custom Shop Edition. This guide covers what the guitar actually is, how it got Aldo Nova's name, why Gibson built it, how many were made, how to tell it apart from the production double-cutaway XPL and the three-pickup Studio Custom XPL, and a detailed look at the 1984 example that came through the shop."
category: "specific-model-highlights"
categoryName: "Specific Model Highlights"
tags: []
heroImage: "/images/blog/gibson-aldo-nova-les-paul-xpl-guide/gibson-aldo-nova-les-paul-xpl-1984-cherry-sunburst.jpg"
heroImageAlt: "A 1984 Gibson Aldo Nova Les Paul XPL in cherry sunburst, a single-cutaway Les Paul Standard with a flamed maple top, two chrome humbuckers, and a pointed Explorer headstock, lying in a blue-lined case."
...
the specs, the rumors, and how to tell a real one from its production cousins
...
The **double-cutaway Les Paul XPL** is a different animal. Gibson listed a double-cutaway model, variously known as the Les Paul XPL, the Les Paul DC, the DC-400, or the Spirit II XPL, from about 1984 to 1987. It has a symmetrical double-cutaway body, the same Explorer headstock, chrome hardware, and it usually left the factory with a Kahler locking tremolo. Finishes ran to Ferrari Red and Heritage sunbursts. These were regular production guitars. They are uncommon today, but they are not in the same league of rarity as the single-cut, and they are worth a fraction of what it brings.

There is also a **three-pickup Studio Custom XPL**, made in 1986 and most often seen in Polaris White. That one matters here because sellers sometimes tag any white Explorer-headstock Gibson as an "Aldo Nova." It is a separate, three-pickup model with its own appointments, not the guitar in these photos.

So the quick test is the body and the layout. One cutaway, two pickups, and a sunburst flame top is the Aldo Nova Standard, the rare one this guide is about. A single cutaway with three pickups, usually in Polaris White, is the Studio Custom XPL. Two cutaways, usually with a Kahler tremolo, is the production DC. All three are honest 1980s Gibsons wearing the same headstock, which is exactly why the names get mixed up.
...
The single-cutaway Aldo Nova sits at the intersection of two things happening at once inside Gibson: the company's habit of building small, special-order runs marked "Custom Shop Edition," years before it opened a formal Custom Shop division in 1993, and a company-wide effort to make the Les Paul look like it belonged in 1984. The result is a guitar that is pure vintage Les Paul from the binding down and pure MTV-era Gibson from the nut up.

## How Many Were Made

This is where the legend takes over, so it is worth being careful about what is actually known.

Aldo Nova himself has said the number is twelve. In interviews he has described the guitar as one he designed and Gibson built for him, that only twelve were made in the world, and that he still owns the first one. Other longtime dealers and collectors put the figure a little higher, at fewer than twenty known examples. Those numbers do not fully agree, and part of the reason is that people count different guitars. The three-pickup 1986 Studio Custom XPL in Polaris White, sometimes described as one of about twenty-five made, gets folded into the "Aldo Nova" tally even though it is a separate model. Count only the two-pickup single-cutaway sunburst Standard and the number stays very small.

What is fair to say is this: Gibson never published a production total for these, so anyone who quotes you an exact count is repeating a story rather than citing a company record. What the surviving guitars do give us is real dating evidence. They carry standard eight-digit Nashville serial numbers, and documented examples decode to late 1984, including a group whose serials fall on a single day, December 20, 1984. Our own example carries a Nashville serial from the same stretch of 1984. So these were a genuine, tightly grouped factory batch, not undocumented one-offs, even though the exact head count was never printed anywhere. The honest version is that the two-pickup Standard was built in very small numbers, somewhere in the low dozens, which puts it among the rarest Gibsons of the decade.

How they were sold is murkier than when they were built. The common account is that the batch went out through Gibson's top dealers rather than normal retail channels, with examples bought new in 1984 from shops as far apart as Dallas and Rochester, New York. Rick Nielsen of Cheap Trick, one of the best-known guitar collectors alive, is known to own more than one. Nova's telling is that the rest of the batch simply went to Nielsen. The more grounded version is that they scattered among dealers and that collectors tracked them down over the following years. Both stories get repeated, which tells you how much of this part lives in memory rather than on paper.

## Specifications

Because so few were made and guitars like this were built to order, you should treat any spec list as a strong tendency rather than a hard rule. Individual examples vary in pickups, hardware color, and finish. The list below describes the single-cutaway sunburst Standard as it is most often seen, and matches the 1984 example pictured in this guide.

| Feature | Specification |
| --- | --- |
| Model | Les Paul Standard with XPL (Explorer) headstock, marked "Custom Shop Edition" |
| Year | Documented sunburst single-cut examples date to 1984 |
...
| Fingerboard | Bound rosewood, pearloid trapezoid inlays, 22 frets (the neck of a Les Paul Standard) |
| Scale | 24.75 inches |
...
| Markings | "Custom Shop Edition" decal, "Made in U.S.A.," and an impressed eight-digit Nashville serial on the back of the headstock |
...
**Check that the top is a carved, figured maple cap.** The Aldo Nova is built on a real Standard, so it should have the carved maple top and cherry sunburst, not a flat or plain top. Combine that with the Explorer headstock and the "Custom Shop Edition" decal and you have a consistent story.

**Know what the neck should be.** Because the single-cut is a Les Paul Standard from the nut down, its neck is a Standard neck: a bound rosewood fingerboard with pearloid trapezoid inlays, which is what our example has. You may run across the claim that a genuine XPL must have an ebony board with dot inlays. That describes the Explorer-necked XPL guitars, the double-cut and the Studio Custom, whose necks were built to echo the Explorer. It is not the right test for the single-cut Standard, and applying it there leads people to doubt real examples.

**Be realistic about spec variation.** Because these were small, built-to-order runs, do not reject a guitar simply because its pickups or hardware do not match some other example you have seen. Look instead for the things that were consistent: the single-cut Standard body, the Explorer headstock, the "Custom Shop Edition" mark, a period-correct Nashville serial, and honest, matching wear across the whole instrument. For a guitar at this value, and with this much folklore attached, a written opinion from someone who can handle it in person is worth getting before money changes hands.

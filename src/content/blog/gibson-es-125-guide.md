...
2.  [The Model Alphabet: Every Variant Explained](#es125-variants)
...
<h2 id="es125-variants">The Model Alphabet: Every ES-125 Variant Explained</h2>

No other Gibson generated quite this many suffix variants. Each letter at the end of the name tells you something specific about the guitar's configuration, and knowing the code is essential for buying or selling these accurately. The short-scale 3/4 model in particular shared a slot in Gibson's student-market thinking with the [LG-series acoustics](/post/joesvintageguitarsaz-com-identify-gibson-lg-series/) of the same era: smaller instruments built for smaller budgets and smaller hands.
...
<figure><img alt="Gibson ES-125D with dual P-90 pickups" src="/images/blog/gibson-es-125-guide/gibson-es-125-d-dual-pickup.jpg" loading="lazy" decoding="async"><figcaption>Gibson ES-125D, the dual P-90 configuration on a full-depth non-cutaway body.</figcaption></figure>

<figure><img alt="Gibson ES-125 3/4 short-scale student model showing the shorter neck and smaller body compared to a full-size ES-125" src="/images/blog/gibson-es-125-guide/gibson-es125-3-4-scaled.jpg" loading="lazy" decoding="async"><figcaption>Gibson ES-125 3/4, the short-scale student model. Note the compressed body length and reduced scale neck.</figcaption></figure>
...
<h2 id="es125-electronics">Electronics: The P-90 Pickup</h2>
...
<figure><img alt="Gibson ES-125 P-90 pickup with black dog-ear cover" src="/images/blog/gibson-es-125-guide/gibson-es-125-p-90-black-cover.jpg" loading="lazy" decoding="async"><figcaption>P-90 dog-ear with black plastic cover, typical of the 1950s and early 1960s.</figcaption></figure>

<figure><img alt="Gibson ES-125 P-90 pickup with chrome cover" src="/images/blog/gibson-es-125-guide/gibson-es-125-p-90-chrome-cover.jpg" loading="lazy" decoding="async"><figcaption>P-90 dog-ear with chrome cover, found on some later examples and on replacement pickups.</figcaption></figure>
...
-   Factory order number (FON) or serial number verifiable in Gibson ledger records (our guide to [reading vintage Gibson serial numbers](/how-to-read-gibson-serial-numbers/) walks through the FON and orange-label systems)

---
title: "How To Tell If Your Acoustic Guitar Needs A Neck Reset"
pubDate: "2026-08-14T12:00:00"
modified: "2026-08-14T12:00:00"
excerpt: "Lay a straightedge down the fretboard and see where it lands on the bridge. If it sits flush on top of the bridge, the neck angle is fine. If it dips into the front face of the bridge, the guitar is due for a neck reset. Here is the whole test, what causes the problem, what the repair costs, and what it means for the value of a vintage Martin, Gibson, or Guild."
category: "value-evaluation"
categoryName: "Value & Evaluation"
tags: []
heroImage: "/images/blog/how-to-tell-if-your-acoustic-guitar-needs-a-neck-reset/neck-reset-straightedge-test-vintage-acoustic.jpg"
heroImageAlt: "Joe Dampt holding a vintage mahogany flat-top guitar with a flat straightedge laid along the fretboard and pointed at the bridge, checking the neck angle."
metaDescription: "A two minute straightedge test tells you whether your acoustic guitar needs a neck reset. What to look for, what causes it, what the repair costs, and how it affects a vintage guitar's value."
ogImage: "/images/blog/how-to-tell-if-your-acoustic-guitar-needs-a-neck-reset/neck-reset-straightedge-test-vintage-acoustic.jpg"
video:
  id: "5vG9ug5XhTI"
  title: "How to Tell If Your Acoustic Guitar Needs a Neck Reset (Simple 2-Minute Test!)"
  description: "Joe Dampt of Joe's Vintage Guitars shows the straightedge test for checking the neck angle on a vintage acoustic guitar, using a Martin with a filed down bridge as the example, and explains what a neck reset costs and how long it takes."
  uploadDate: "2026-08-14T10:04:20-07:00"
  seconds: 203
  chapters:
    - { start: 0, name: "Why Vintage Acoustics Need Neck Resets" }
    - { start: 33, name: "The Only Tool You Need" }
    - { start: 63, name: "A Filed Down Bridge On A Martin" }
    - { start: 113, name: "Using The Straightedge To Measure The Angle" }
    - { start: 141, name: "A Neck Reset Is Normal Maintenance" }
    - { start: 158, name: "Cost And Time Considerations" }
    - { start: 187, name: "Conclusion" }
toc:
  - { href: "#the-test", label: "The Straightedge Test" }
  - { href: "#reading-it", label: "Reading The Result", sub: true }
  - { href: "#why", label: "Why This Happens" }
  - { href: "#other-signs", label: "The Other Signs" }
  - { href: "#saddle", label: "A Saddle Filed To Nothing", sub: true }
  - { href: "#shaved-bridge", label: "A Shaved Bridge", sub: true }
  - { href: "#which-guitars", label: "Which Guitars This Applies To" }
  - { href: "#cost", label: "Cost And Turnaround" }
  - { href: "#value", label: "What It Does To Value" }
...
<p class="bpost-video-note">Three minutes, one straightedge, and a Martin with a filed down bridge as the example. The test itself starts at 1:53.</p>
...
![The rosewood bridge of a vintage Gibson flat-top guitar photographed from above, with a light colored saddle standing only slightly proud of the bridge surface and eight bridge pins in a row.](../../assets/blog/how-to-tell-if-your-acoustic-guitar-needs-a-neck-reset/vintage-gibson-acoustic-bridge-saddle-height.jpg)
...
![A 1976 Martin 000-45 photographed straight on, showing the spruce top, abalone trim around the body and soundhole, ebony bridge, and pearl inlaid ebony fretboard.](../../assets/blog/how-to-tell-if-your-acoustic-guitar-needs-a-neck-reset/1976-martin-000-45-vintage-flat-top.jpg)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can I fix a neck reset with the truss rod?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. A truss rod bends the neck to control relief, the small amount of forward curve along the fretboard. A neck reset changes the angle at which the whole neck meets the body. They are separate adjustments for separate problems, and using the truss rod to chase high action usually leaves a back-bowed neck that buzzes and still plays high."
      }
    },
    {
      "@type": "Question",
      "name": "Does my guitar need a neck reset if the action is high?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not necessarily. High action can come from neck relief, a saddle that is too tall, a nut cut high, a lifting bridge, or a bellied top. Run the straightedge test first, because that is what separates a neck angle problem from everything else."
      }
    },
    {
      "@type": "Question",
      "name": "How do you tell if an acoustic guitar needs a neck reset?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tune the guitar to pitch, then lay a straightedge flat along the center of the fretboard so it rests on the frets and reaches the bridge. If it lands flush on top of the bridge, the neck angle is healthy. If it dips and hits the front face of the bridge below the top surface, the neck has tipped forward and the guitar is due for a reset."
      }
    },
    {
      "@type": "Question",
      "name": "Is a neck reset permanent?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It should last decades, but it is not literally forever. The same string tension keeps working on the same wood, so a guitar reset in the 1980s can be ready for another one now. On a guitar that gets normal use and reasonable storage, a reset is a once in a generation job."
      }
    },
    {
      "@type": "Question",
      "name": "Does a neck reset hurt the value of a vintage guitar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A properly done neck reset carries almost no penalty, because on a guitar sixty years old it is expected maintenance and it does not affect original finish, parts, or bracing. A guitar that still needs one is usually discounted by roughly the cost of the work. The costly situation is a shortcut, such as a shaved bridge or a badly done reset, which costs more to undo than the original job would have."
      }
    }
  ]
}

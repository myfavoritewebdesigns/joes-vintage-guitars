...
![A large vintage guitar collection purchased by Joe's Vintage Guitars, hundreds of instruments evaluated and acquired in a single visit](../../assets/blog/how-to-sell-a-large-guitar-collection-every-option-honestly-explained/large-vintage-guitar-collection.jpg)

<figcaption>A real collection we purchased. Instruments evaluated, documented, and acquired in a single visit by Joe's Vintage Guitars.</figcaption>
...
-   **No documentation.** Plenty of collectors never kept formal records. Receipts, serial number logs, purchase histories. Gone, or buried in estate paperwork that hasn't been opened yet. Without documentation, dating and authenticating vintage instruments takes hands-on expertise. Our brand-specific serial number guides for [Fender](/fender-guitars-serial-number-guide/), [Gibson](/how-to-read-gibson-serial-numbers/), [Gretsch](/gretsch-serial-number-lookup/), [Rickenbacker](/rickenbacker-serial-numbers/), and [Martin](/martin-serial-and-model-numbers/) are a useful place to start, but for a large inherited collection a hands-on evaluation beats researching each instrument one at a time.
...
<h2 id="inventory">Before You List a Single Guitar: Taking Inventory the Right Way</h2>
...
-   **Serial number.** Photograph it before anything else. It's your proof of authenticity and how you verify the manufacture date against factory records. Cross-reference against the right brand guide, see our serial number guides for [Fender](/fender-guitars-serial-number-guide/), [Gibson](/how-to-read-gibson-serial-numbers/), [Gretsch](/gretsch-serial-number-lookup/), [Rickenbacker](/rickenbacker-serial-numbers/), and [Martin](/martin-serial-and-model-numbers/).
...
**Serial number guides by brand:** Decoding a serial number tells you the actual manufacture year, the factory it came from, and sometimes the production sequence. All of which matter for pricing and authenticity. Use our free guides: [Fender Serial Numbers](/fender-guitars-serial-number-guide/) · [Gibson Serial Numbers](/how-to-read-gibson-serial-numbers/) · [Gretsch Serial Numbers](/gretsch-serial-number-lookup/) · [Rickenbacker Serial Numbers](/rickenbacker-serial-numbers/) · [Martin Serial & Model Numbers](/martin-serial-and-model-numbers/)
...
**Important on vintage guitars:** "All original" is a specific, defensible claim. Verify it before you make it. Check tuner buttons, pot dates (accessible through the cavity covers), pickup wire integrity, solder joints. A single replaced tuner drops an otherwise all-original vintage guitar into a different valuation tier, and you need to know that before you price it. Our serial number guides for [Fender](/fender-guitars-serial-number-guide/), [Gibson](/how-to-read-gibson-serial-numbers/), and [Martin](/martin-serial-and-model-numbers/) can help you confirm manufacture dates before you make any claims about originality.
...
<h2 id="facebook">Selling on Facebook Marketplace</h2>
...
<h2 id="craigslist">Selling on Craigslist</h2>
...
<h2 id="other-platforms">Other Platforms Worth Knowing</h2>
...
<h2 id="comparison">Platform Comparison at a Glance</h2>
...
<h2 id="sell-to-us">Why Collectors and Their Families Choose to Sell to Us</h2>
...
> 
> ](https://www.instagram.com/reel/C7RuJUeRW2O/?utm_source=ig_embed&utm_campaign=loading)

> [
> 
> View this post on Instagram
> 
> ](https://www.instagram.com/reel/C3oOvxOvFJp/?utm_source=ig_embed&utm_campaign=loading)
...
When we evaluate a collection, we bring the expertise to work through exactly that kind of situation. We'll go through everything methodically, identify each instrument, note condition and originality, pull serial numbers against the appropriate factory records (using resources like our [Fender](/fender-guitars-serial-number-guide/), [Gibson](/how-to-read-gibson-serial-numbers/), [Gretsch](/gretsch-serial-number-lookup/), [Rickenbacker](/rickenbacker-serial-numbers/), and [Martin](/martin-serial-and-model-numbers/) serial number guides), and build an organized picture of what's there. You don't need to do any of that before calling us. That's precisely where we add value no online platform can replicate.

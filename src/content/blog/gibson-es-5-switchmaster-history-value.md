---
title: "The Gibson ES-5 and ES-5 Switchmaster: History, Authentication, and Value"
pubDate: "2026-07-13T12:00:00"
modified: "2026-07-13T12:00:00"
excerpt: "The Gibson ES-5 was the first production Spanish electric with three pickups, a plush cousin of the L-5 that Gibson sold as the instrument of a thousand voices. This guide covers where it came from, how the original three-P-90 ES-5 became the four-way ES-5 Switchmaster, how the Switchmaster moved to three PAF humbuckers, and how we date, authenticate, and value each one. Every photo is a real ES-5 from our shop, including a 1953 original and a 1958 PAF Switchmaster."
...
<nav class="es5-nav-sidebar" id="es5NavSidebar" aria-label="Article section navigation">
  ...
  <div class="es5-nav-label">The Guitar</div>
  <a href="#es5-what" class="es5-nav-link"><span class="es5-nav-dot"></span>The Short Version</a>
  <a href="#es5-history" class="es5-nav-link"><span class="es5-nav-dot"></span>The First Three-Pickup Gibson</a>
  <a href="#es5-original" class="es5-nav-link"><span class="es5-nav-dot"></span>The Original ES-5</a>
  <a href="#es5-switchmaster" class="es5-nav-link"><span class="es5-nav-dot"></span>The Switchmaster Arrives</a>
  <a href="#es5-humbuckers" class="es5-nav-link"><span class="es5-nav-dot"></span>From P-90s to PAFs</a>
  <a href="#es5-built" class="es5-nav-link"><span class="es5-nav-dot"></span>How It Was Built</a>
  <a href="#es5-timeline" class="es5-nav-link"><span class="es5-nav-dot"></span>Year by Year</a>
  <a href="#es5-players" class="es5-nav-link"><span class="es5-nav-dot"></span>Who Played One</a>
  <div class="es5-nav-label">Dating &amp; Authentication</div>
  <a href="#es5-dating" class="es5-nav-link"><span class="es5-nav-dot"></span>Dating Your ES-5</a>
  <a href="#es5-authenticate" class="es5-nav-link"><span class="es5-nav-dot"></span>Reading One Like a Dealer</a>
  <a href="#es5-mods" class="es5-nav-link"><span class="es5-nav-dot"></span>Mods and Red Flags</a>
  <a href="#es5-checklist" class="es5-nav-link"><span class="es5-nav-dot"></span>The Checklist</a>
  <div class="es5-nav-label">Value</div>
  <a href="#es5-value" class="es5-nav-link"><span class="es5-nav-dot"></span>What It Is Worth</a>
  <a href="#es5-reissue" class="es5-nav-link"><span class="es5-nav-dot"></span>Vintage or Reissue</a>
  <a href="#es5-selling" class="es5-nav-link"><span class="es5-nav-dot"></span>Thinking of Selling</a>
  <a href="#es5-faq" class="es5-nav-link"><span class="es5-nav-dot"></span>FAQ</a>
</nav>

<button class="es5-nav-btn" id="es5NavBtn" onclick="toggleEs5Nav()" aria-expanded="false" aria-controls="es5NavPanel" type="button">
  <span class="es5-nav-icon">&#9776;</span> Jump To Section
</button>

<div class="es5-nav-panel" id="es5NavPanel" role="navigation" aria-label="Article section navigation">
  <div class="es5-nav-header"><strong>ES-5 Guide</strong></div>
  <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});closeEs5Nav();return false;" class="es5-nav-link top">&uarr; Top of Page</a>
  <div class="es5-nav-label">The Guitar</div>
  <a href="#es5-what" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>The Short Version</a>
  <a href="#es5-history" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>The First Three-Pickup Gibson</a>
  <a href="#es5-original" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>The Original ES-5</a>
  <a href="#es5-switchmaster" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>The Switchmaster Arrives</a>
  <a href="#es5-humbuckers" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>From P-90s to PAFs</a>
  <a href="#es5-built" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>How It Was Built</a>
  <a href="#es5-timeline" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Year by Year</a>
  <a href="#es5-players" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Who Played One</a>
  <div class="es5-nav-label">Dating &amp; Authentication</div>
  <a href="#es5-dating" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Dating Your ES-5</a>
  <a href="#es5-authenticate" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Reading One Like a Dealer</a>
  <a href="#es5-mods" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Mods and Red Flags</a>
  <a href="#es5-checklist" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>The Checklist</a>
  <div class="es5-nav-label">Value</div>
  <a href="#es5-value" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>What It Is Worth</a>
  <a href="#es5-reissue" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Vintage or Reissue</a>
  <a href="#es5-selling" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>Thinking of Selling</a>
  <a href="#es5-faq" onclick="closeEs5Nav()" class="es5-nav-link"><span class="es5-nav-dot"></span>FAQ</a>
</div>
...
![A natural, or blonde, Gibson ES-5 with three dog-ear P-90 pickups, the rarer and more valuable finish.](../../assets/blog/gibson-es-5-switchmaster-history-value/gibson-es-5-natural-blonde-p90.jpg)
...
![Top view of a 1953 Gibson ES-5 showing three dog-ear P-90 pickups, three volume knobs, and a master tone knob with no selector switch.](../../assets/blog/gibson-es-5-switchmaster-history-value/1953-gibson-es-5-three-p90-controls.jpg)
...
![Bound rosewood fingerboard of a vintage Gibson ES-5 with large mother-of-pearl block inlays.](../../assets/blog/gibson-es-5-switchmaster-history-value/1953-gibson-es-5-pearl-block-inlays.jpg)
...
![The four-way Switchmaster selector switch on a 1958 Gibson ES-5, its engraved plate reading positions one, two, three, and All.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-selector-switch.jpg)
...
![Three humbucker pickups and six gold knobs on a 1958 Gibson ES-5 Switchmaster in sunburst.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-humbuckers-gold-knobs.jpg)
...
![Headstock of a 1958 Gibson ES-5 Switchmaster showing the gold Gibson logo and the pearl crown inlay on a bound black headstock.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-headstock-crown-inlay.jpg)
...
![Bound rosewood fingerboard with large pearl block inlays on a 1958 Gibson ES-5 Switchmaster.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-pearl-block-inlays.jpg)
...
![Gold tune-o-matic bridge and wavy wire tailpiece on a 1958 Gibson ES-5 Switchmaster.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-tune-o-matic-tailpiece.jpg)
...
![A white oval Gibson guarantee label reading serial number A-15380 inside a 1953 ES-5.](../../assets/blog/gibson-es-5-switchmaster-history-value/1953-gibson-es-5-guarantee-label-serial.jpg)
...
![An orange oval Gibson guarantee label reading Gibson Switchmaster and serial number A-27756 inside a 1958 ES-5.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-guarantee-label-serial.jpg)
...
![The upgraded gold tune-o-matic bridge on a rosewood base on a 1953 Gibson ES-5.](../../assets/blog/gibson-es-5-switchmaster-history-value/1953-gibson-es-5-tune-o-matic-bridge.jpg)
...
![Back of a 1958 Gibson ES-5 Switchmaster headstock showing replaced chrome Grover tuners.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-grover-tuners-headstock-back.jpg)
...
![Back of a 1958 Gibson ES-5 Switchmaster in sunburst showing figured maple and honest wear.](../../assets/blog/gibson-es-5-switchmaster-history-value/1958-gibson-es-5-switchmaster-sunburst-back.jpg)

The figured maple back of our 1958. Honest, original finish with the kind of light wear a well-kept guitar earns over sixty-plus years is exactly what we want to see, and it is worth more than a guitar that has been refinished to look new.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the difference between a Gibson ES-5 and an ES-5 Switchmaster?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "They are the same model at two stages of its life. The original ES-5, from 1949 to about 1955, has three P-90 pickups, three volume knobs and a master tone, and no pickup selector switch. In 1955 Gibson added a four-way selector switch and a second row of knobs, giving each pickup its own volume and tone, and renamed the guitar the ES-5 Switchmaster. So six knobs and a four-way switch means a Switchmaster, and four knobs with no switch means the earlier ES-5."
      }
    },
    {
      "@type": "Question",
      "name": "How can I tell what year my Gibson ES-5 is?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Start with the features. Four knobs and no switch is 1949 to 1955, six knobs and a switch is 1955 and later, P-90s are 1949 to 1957, humbuckers are 1957 and later, and a rounded cutaway is pre-1960 while a pointed one is 1960 to 1962. Then confirm with the A-prefix serial on the oval label inside the body and the factory order number stamped inside. A white label points to before 1955 and an orange label to 1955 or later."
      }
    ...
    {
      "@type": "Question",
      "name": "Does the ES-5 have soapbar or dog-ear P-90s?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Dog-ear. Because the ES-5 has a fully hollow body with no solid wood under the top, Gibson used dog-ear P-90s, whose extended tabs at each end let the pickup screw straight to the top. Soapbar P-90s mount from below into a routed cavity and are used on solidbodies and semi-hollows, not on a hollow archtop like the ES-5."
      }
    },
    {
      "@type": "Question",
      "name": "Why is the ES-5 Switchmaster with PAF humbuckers so valuable?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Because it carries three genuine PAF humbuckers, the same sought-after late-1950s pickup that makes a Les Paul valuable, and three of them on one guitar is rare. Many Switchmasters have been taken apart over the years so their PAFs could be sold into Les Pauls, so an intact, original three-PAF Switchmaster is scarcer every year, which is a big part of why collectors chase it."
      }
    },
    {
      "@type": "Question",
      "name": "What is my vintage Gibson ES-5 worth?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A sunburst ES-5 in honest, all-original condition generally runs from about 8,000 dollars for an early three-P-90 guitar to around 20,000 dollars for a round-cutaway three-PAF Switchmaster, with modified or refinished examples selling for less. The rare natural finish adds a strong premium on top. Condition and originality matter more than anything else, and the market is thin, so the only real way to know is to have your specific guitar appraised."
      }
    ...
    {
      "@type": "Question",
      "name": "Is a natural, or blonde, ES-5 worth more than a sunburst?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Natural was a lower-production special finish, roughly a third of all ES-5s, so a clean blonde carries a real premium over the same guitar in sunburst, often in the range of 30 to 60 percent. A natural PAF Switchmaster is the most valuable configuration of all."
      }
    },
    {
      "@type": "Question",
      "name": "Is a modern Gibson ES-5 reissue worth as much as a vintage one?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The Custom Shop reissues from the mid-1990s and later are good guitars, but they sell used for around five to sixty-five hundred dollars, a fraction of a vintage original and a small fraction of a real three-PAF Switchmaster. You can spot a reissue by its modern serial format, modern pots and pickups, and the absence of genuine aged finish and pearl."
      }
    }
  ]
}
...
<style>
  /* Floating in-page nav for this post (es5-nav), ported from the esh-nav pattern. */
  .es5-nav-btn { display: none; position: fixed; left: 24px; bottom: 1.5rem; top: auto; right: auto; z-index: 9999; background: #b93c15; color: #fff; border: none; border-radius: 50px; padding: 13px 22px; font-family: var(--font-display, Oswald), sans-serif; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; cursor: pointer; box-shadow: 0 4px 20px rgba(185,60,21,.45); align-items: center; gap: 8px; transition: background .2s, box-shadow .2s, transform .2s; }
  .es5-nav-btn:hover { background: #9a3010; box-shadow: 0 6px 28px rgba(185,60,21,.55); transform: translateY(-2px); }
  .es5-nav-btn.open { background: #7b1d1d; }
  .es5-nav-icon { font-size: 15px; line-height: 1; transition: transform .3s; }
  .es5-nav-btn.open .es5-nav-icon { transform: rotate(45deg); }
  .es5-nav-sidebar { position: fixed; top: 170px; right: 24px; z-index: 25; width: 260px; max-height: calc(100vh - 200px); overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,.12); display: none; flex-direction: column; transition: opacity .25s; }
  .es5-nav-sidebar.es5-nav-hidden { opacity: 0; pointer-events: none; }
  .es5-nav-panel { position: fixed; left: 24px; bottom: 5rem; top: auto; right: auto; z-index: 9998; width: 300px; max-height: 70vh; overflow-y: auto; background: #fff; border: 1px solid #e0dacc; border-radius: 14px; box-shadow: 0 12px 40px rgba(0,0,0,.18); flex-direction: column; display: none; }
  .es5-nav-panel.open { display: flex; }
  .es5-nav-header { background: #7b1d1d; padding: 16px 18px; border-radius: 10px 10px 0 0; flex-shrink: 0; }
  .es5-nav-header strong { display: block; color: #fff; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .1em; }
  .es5-nav-label { background: #f4f0e8; padding: 7px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 10px; font-weight: 700; color: #7a6b5d; text-transform: uppercase; letter-spacing: .1em; border-bottom: 1px solid #e0dacc; flex-shrink: 0; }
  .blog-prose .es5-nav-link, .blog-prose .es5-nav-link:link, .blog-prose .es5-nav-link:visited { display: flex; padding: 10px 18px; font-family: var(--font-display, Oswald), sans-serif; font-size: 12px; font-weight: 700; color: #4a3427 !important; text-decoration: none !important; text-transform: uppercase; letter-spacing: .04em; border-bottom: 1px solid #f0ebe3; transition: background .15s, color .15s; align-items: center; gap: 8px; }
  .blog-prose .es5-nav-link:last-child { border-bottom: none; }
  .blog-prose .es5-nav-link:focus, .blog-prose .es5-nav-link:hover { background: #f9f7f2; color: #b93c15 !important; text-decoration: none !important; }
  .blog-prose .es5-nav-link.top, .blog-prose .es5-nav-link.top:link, .blog-prose .es5-nav-link.top:visited { background: #fff8f0; color: #b93c15 !important; border-bottom: 2px solid #e0dacc; text-decoration: none !important; }
  .blog-prose .es5-nav-link.top:hover { background: #fef0e6; }
  .es5-nav-dot { width: 6px; height: 6px; border-radius: 50%; background: #b93c15; flex-shrink: 0; }
  @media (min-width: 1100px) {
    .es5-nav-sidebar { display: flex; }
    .es5-nav-btn { display: none !important; }
    .es5-nav-panel { display: none !important; }
  ...
  @media (max-width: 1099.98px) {
    .es5-nav-sidebar { display: none !important; }
    .es5-nav-btn { display: flex; }
  }
  @media (max-width: 480px) {
    .es5-nav-panel { left: 16px; bottom: 5rem; width: calc(100vw - 32px); max-width: 320px; }
  }
...
<script>
  function toggleEs5Nav() {
    var btn = document.getElementById('es5NavBtn');
    var panel = document.getElementById('es5NavPanel');
    if (!btn || !panel) return;
    if (panel.classList.contains('open')) { closeEs5Nav(); }
    else { panel.classList.add('open'); btn.classList.add('open'); btn.setAttribute('aria-expanded', 'true'); }
  }
  function closeEs5Nav() {
    var btn = document.getElementById('es5NavBtn');
    var panel = document.getElementById('es5NavPanel');
    if (!btn || !panel) return;
  ...
  document.addEventListener('click', function (e) {
    ...
    var panel = document.getElementById('es5NavPanel');
    if (!btn || !panel) return;
    if (!btn.contains(e.target) && !panel.contains(e.target)) closeEs5Nav();
  });
  (function () {
    function initEs5Fade() {
      var contact = document.getElementById('contact');
      var sidebar = document.getElementById('es5NavSidebar');
      if (contact && sidebar && 'IntersectionObserver' in window) {
        new IntersectionObserver(function (entries) {
          sidebar.classList.toggle('es5-nav-hidden', entries[0].isIntersecting);
        }).observe(contact);
      }
    }
    if (document.readyState === 'loading') { document.addEventListener('DOMContentLoaded', initEs5Fade); }
    else { initEs5Fade(); }
  })();
</script>
